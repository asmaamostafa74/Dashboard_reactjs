...
const Numbers = () => {
    return (
        <div className='flex flex-wrap gap-4 mt-10 animate__animated animate__backInDown'>
            <div className="flex w-[370px] items-center justify-between px-5 h-20 bg-white rounded-2xl animate__animated animate__backInDown">
                <div>
